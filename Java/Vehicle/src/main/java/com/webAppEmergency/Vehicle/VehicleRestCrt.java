...
//////////////////////////////////////
	...
	@RequestMapping(method=RequestMethod.PUT, value="/setDeplacement/{id}/{deplacement}")
	public void setDeplacement(@PathVariable int id, @PathVariable int deplacement) {
		vService.setDeplacement(id, deplacement);
	}
